...
export async function GET(req:Request){
  try{
    ...
    const [usage,unread,budget,providerBilling,runtime,systemPrompt,creativePrompt]=await Promise.all([
    ...
    return NextResponse.json({
      ...
      runtime:{safeMode:runtime.safeMode,autoRoutingEnabled:runtime.autoRoutingEnabled},
